...
;(function($, window, document)
{
	...
	$.fn.wizard.defaults = {
		 ...
		 * @var string
		 */
		controlPrev: '<button type="button" class="button glossy mid-margin-right wizard-prev float-left"><span class="button-icon anthracite-gradient"><span class="icon-backward"></span></span>geri</button>',

		/**
		 * Next button markup - must use class 'wizard-next'
		 * @var string
		 */
		controlNext: '<button type="button" class="button glossy mid-margin-right wizard-next float-right">ileri<span class="button-icon right-side"><span class="icon-forward"></span></span></button>',
