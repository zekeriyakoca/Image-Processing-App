...
;(function($, window, document, undefined)
{
	...
	window.notify.defaults = {
		 ...
		 * @var boolean
		 */
		textOneSimilar: 'Bir benzer bildirim', //'One similar notification',
		 ...
		 * @var boolean
		 */
		textSeveralSimilars: '%d benzer bildirim', //'%d similar notifications',
		 ...
		 * @var boolean
		 */
		textOneMore: 'Bir kez daha bildirim', //'One more notification',
		 ...
		 * @var boolean
		 */
		textSeveralMore: '%d kez daha bildirim', //'%d more notifications',
